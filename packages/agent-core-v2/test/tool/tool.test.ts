  ...
  describe('registered user tools', () => {
    ...
    it('routes registered user tools through tool.call request/response', async () => {
      ...
      expect(
        ...
        [wire] token_counting.measured     { "agentId": "main", "length": 3, "tokens": 149, "time": "<time>" }
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [wire] llm.request                 { "agentId": "main", "kind": "loop", "provider": "openai", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 1000000, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "42111a1b45263de5001dbe2e05192861fc6e2b067e45d0146a4a9f5e131de9a6", "messageCount": 4, "turnStep": "0.2", "time": "<time>" }
        ...
        [wire] token_counting.measured     { "agentId": "main", "length": 5, "tokens": 165, "time": "<time>" }
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [wire] token_counting.measured        { "agentId": "main", "length": 7, "tokens": 183, "time": "<time>" }
